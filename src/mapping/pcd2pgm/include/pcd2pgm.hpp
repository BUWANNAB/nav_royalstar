...
private:
  ...
  struct DefaultParameters {
    static constexpr const char* DEFAULT_PCD_FILE = "$HOME/inHome/pcd/point_cloud.pcd";
    ...
    static constexpr const char* DEFAULT_MAP_SAVE_PATH = "$HOME/inHome/maps/";
    static constexpr const char* DEFAULT_MAP_SAVE_NAME = "temp_pgmmap";
    static constexpr const char* DEFAULT_ROTATED_PCD_SAVE_PATH = "$HOME/inHome/pcd/pcdmap.pcd";
  };
  ...
  std::string config_file_path_; // YAML配置文件路径
