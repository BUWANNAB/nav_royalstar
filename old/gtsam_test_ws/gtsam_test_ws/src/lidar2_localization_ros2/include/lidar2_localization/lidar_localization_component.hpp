...
#include "lidar2_localization/lidar_undistortion.hpp"
...
public:
  ...
  void mapPathReceived(const std_msgs::msg::String::ConstSharedPtr msg);
  // void gnssReceived();
  ...
  //状态发布
  rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr slam_status_pub_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr slam_pos_type_pub_;
